...
{
    public class OrchidLocalDbContext(DbContextOptions<OrchidLocalDbContext> options) : DbContext(options), IUnitOfWork
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(OrchidLocalDbContext).Assembly);
